...
BOOST_LIBS="context filesystem program_options regex system thread"
...
patchBoost()
{
    ...
    if [ ! -f $BOOST_SRC/tools/build/src/tools/gcc.jam.orig ]; then
        cp -f $BOOST_SRC/tools/build/src/tools/gcc.jam $BOOST_SRC/tools/build/src/tools/gcc.jam.orig
    else
        cp -f $BOOST_SRC/tools/build/src/tools/gcc.jam.orig $BOOST_SRC/tools/build/src/tools/gcc.jam
    fi
    patch $BOOST_SRC/tools/build/src/tools/gcc.jam $CURRENT_DIR/gcc.jam.patch

    if [ ! -f $BOOST_SRC/tools/build/src/tools/features/instruction-set-feature.jam.orig ]; then
        cp -f $BOOST_SRC/tools/build/src/tools/features/instruction-set-feature.jam $BOOST_SRC/tools/build/src/tools/features/instruction-set-feature.jam.orig
    else
        cp -f $BOOST_SRC/tools/build/src/tools/features/instruction-set-feature.jam.orig $BOOST_SRC/tools/build/src/tools/features/instruction-set-feature.jam
    fi
    patch $BOOST_SRC/tools/build/src/tools/features/instruction-set-feature.jam $CURRENT_DIR/instruction-set-feature.jam.patch

    if false; then
    if [ ! -f $BOOST_SRC/tools/build/src/build/configure.jam.orig ]; then
        cp -f $BOOST_SRC/tools/build/src/build/configure.jam $BOOST_SRC/tools/build/src/build/configure.jam.orig
    else
        cp -f $BOOST_SRC/tools/build/src/build/configure.jam.orig $BOOST_SRC/tools/build/src/build/configure.jam
    fi
    patch $BOOST_SRC/tools/build/src/build/configure.jam $CURRENT_DIR/configure.jam.patch
    fi
}
